                  ...
                  <FormItem className="rounded-md border p-2">
                    <div>
                      ...
                      <FormDescription>
                        ...
                        result in items with a very high profit, which will
                        likely never sell.
                      </FormDescription>
                    </div>
                    <FormControl>
                  ...
                  <FormItem className="rounded-md border p-2">
                    <div>
                      ...
                      <FormDescription>
                        ...
                        last 24 hours. This is used to filter out prices which
                        are not likely to sell due to low demand.
                      </FormDescription>
                    </div>
                    <FormControl>
        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="text-right">Historical prices</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {isFetching ? (
